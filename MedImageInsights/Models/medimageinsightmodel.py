...
from MedImageInsights.Models.UniCLModel import build_unicl_model
from MedImageInsights.Utils.Arguments import load_opt_from_config_files
from MedImageInsights.ImageDataLoader import build_transforms
...
class MedImageInsight:
    ...
    def __init__(
            self,
            model_dir: str = "v20240927",
            vision_model_name: str = "medimageinsight-v1.0.0.pt",
